...
async function updateLiveTempestCurrent() {
  try {
    const response = await fetch("http://132.145.154.22:3000/api/tempest/current");
...
async function updateGraphHistory() {
  try {
    const [tempResp, pressureResp] = await Promise.all([
      fetch("http://132.145.154.22:3000/api/history/temperature"),
      fetch("http://132.145.154.22:3000/api/history/pressure")
    ]);
...
async function updateLiveLightning() {
  try {
    const response = await fetch("http://132.145.154.22:3000/api/tempest/lightning");
    if (!response.ok) throw new Error(`HTTP ${response.status}`);
...
async function updateLiveNwsAlerts() {
  try {
    const response = await fetch("http://132.145.154.22:3000/api/nws-alerts");
    if (!response.ok) throw new Error(`HTTP ${response.status}`);
...
async function loadRegionalTemps() {
  ...
  try {
    const response = await fetch("http://132.145.154.22:3000/api/regional-temps");
    if (!response.ok) throw new Error(`HTTP ${response.status}`);
...
async function loadForecastScreenData() {
  try {
    const forecastResp = await fetch("http://132.145.154.22:3000/api/nws-forecast", {
      cache: "no-store"
    });
